...
import org.macula.uid.utils.DateUtils;
...
public class DefaultUidGenerator implements UidGenerator, InitializingBean {
    ...
    protected synchronized long nextId() {
        ...
        // Clock moved backwards, refuse to generate org.macula.uid.uid
        ...
        if (currentSecond == lastSecond) {
            ...
            // Exceed the max sequence, we wait the next second to generate org.macula.uid.uid
            if (sequence == 0) {
