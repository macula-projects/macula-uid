 ...
 */
package org.macula.uid.generator.impl;

import org.macula.uid.generator.BitsAllocator;
import org.macula.uid.generator.UidGenerator;
import org.macula.uid.buffer.BufferPaddingExecutor;
import org.macula.uid.buffer.RejectedPutBufferHandler;
import org.macula.uid.buffer.RejectedTakeBufferHandler;
import org.macula.uid.buffer.RingBuffer;
import org.macula.uid.config.UidProperties;
import org.macula.uid.exception.UidGenerateException;
...
@ConfigurationProperties(prefix = "macula.org.macula.uid.uid.cached-org.macula.uid.uid-generator")
